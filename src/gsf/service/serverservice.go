...
func NewServerService(dispatcher dispatcher.IDispatcher, serverSocket socket.IServerSocket) *ServerService {
...
func (service *ServerService) GetDispatcher() dispatcher.IDispatcher {
